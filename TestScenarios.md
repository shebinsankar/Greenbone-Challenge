...
Other features, sorting, cart counter are medium priority tests.

Navigations check and cosmetic changes in app can be low priority, which will not block the users.
